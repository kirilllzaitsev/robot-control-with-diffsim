...
PATH = "learn_controller/single_action/Results/" + ALGO + "/" + MODEL_ID + "/"
SUFFIX = "final_model"
...
parser.add_argument(
    ...
    type=str,
    default="learn_controller/single_action/agent_params.json",
)
...
if __name__ == "__main__":
    ...
    env = SubprocVecEnv([make_env("SimpleBallThrowing-v0", i) for i in range(num_cpu)])
    ...
    model = TD3(
        ...
        policy_kwargs=dict(activation_fn=torch.nn.Tanh, net_arch=params["net_arch"]),
    )
